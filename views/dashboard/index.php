    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            ...
            <div class="statistic-box statistic-filled-1">
                <h2>
                    <span class="count-number"><?= Users::find()->where(['is_deleted' => 0])->count() ?></span>
                </h2>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            ...
            <div class="statistic-box statistic-filled-4">
                <h2>
                    <span class="count-number"><?= Projects::find()->where(['is_deleted' => 0])->count(); ?></span>
                </h2>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
            ...
            <div class="statistic-box statistic-filled-3">
                <h2>
                    <span class="count-number"><?= Tasks::find()->where(['is_deleted' => 0, 'status' => 'Complete'])->count() ?></span>
                </h2>
                <div class="small">Total Completed Tasks</div>
            ...
            <div class="statistic-box statistic-filled-2">
                <h2>
                    <span class="count-number">
                        <?= Tasks::find()->where(['is_deleted' => 0,])
                            ->andWhere(['!=', 'status', 'Complete'])
                            ->count(); ?>
                    </span>
                </h2>
                <div class="small">Total Remaining Tasks</div>
                <i class="ti-world statistic_icon"></i>
                <div class="sparkline3 text-center"></div>
            </div> <!-- /.statistic box -->
        </div>
